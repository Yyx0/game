...
// alert(m1);
if (m1 == 0) {
	monsterImage.src = "images/a1.png";

} else {
	monsterImage.src = "images/a2.png";
...
// alert(m1);
if (m1 == 0) {
	monsterImage2.src = "images/a1.png";

} else {
	monsterImage2.src = "images/a2.png";
...
var update = function (modifier) {
	...
	if (37 in keysDown && hero.x >= 20) { // Player holding left
		...
		heroImage.src = "images/b2.png";
	}
	if (39 in keysDown && hero.x <= 450) { // Player holding right
		hero.x += hero.speed * modifier;
		heroImage.src = "images/b3.png";
	}
...
var render = function () {
	...
	ctx.fillText("捕捉数: " + monstersCaught, 32, 22);
	ctx.fillText("捕捉等级: " + gqs, 32, 60);
	ctx.fillText("目标是捕捉: " + tj + "个小精灵", 200, 22);
